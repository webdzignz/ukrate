...
const LoadingPage: React.FC = () => {
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-[#012169] via-[#C8102E] to-red-900 flex items-center justify-center z-50 overflow-hidden">
      {/* Animated background particles */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/4 w-3 h-3 bg-white/20 rounded-full animate-pulse"></div>
        <div className="absolute top-3/4 right-1/4 w-2 h-2 bg-red-300/30 rounded-full animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 right-1/3 w-2.5 h-2.5 bg-white/25 rounded-full animate-pulse delay-500"></div>
        <div className="absolute top-1/3 left-1/2 w-1.5 h-1.5 bg-red-400/40 rounded-full animate-pulse delay-1500"></div>
        <div className="absolute bottom-1/4 left-1/3 w-2 h-2 bg-white/30 rounded-full animate-pulse delay-2000"></div>
        <div className="absolute top-1/6 right-1/6 w-1 h-1 bg-red-300/50 rounded-full animate-pulse delay-700"></div>
        <div className="absolute bottom-1/3 right-2/3 w-1.5 h-1.5 bg-white/20 rounded-full animate-pulse delay-1200"></div>
        <div className="absolute top-2/3 left-1/6 w-2 h-2 bg-red-400/30 rounded-full animate-pulse delay-1800"></div>
      </div>
      ...
      <div className="relative z-10 text-center animate-in fade-in-50 zoom-in-95 duration-1000">
        ...
        <p className="text-lg text-red-100 mb-12 animate-in slide-in-from-bottom-2 duration-1000 delay-500">
        ...
        <div className="w-80 max-w-sm mx-auto mb-8 animate-in slide-in-from-bottom-2 duration-1000 delay-700">
          <div className="bg-white/20 rounded-full h-2 overflow-hidden backdrop-blur-sm">
            <div className="h-full bg-gradient-to-r from-red-400 via-red-300 to-white rounded-full animate-loading-bar shadow-lg"></div>
          </div>
        </div>
        ...
        <div className="flex justify-center mb-8 animate-in fade-in-50 duration-1000 delay-900">
          <div className="relative">
            ...
            <div className="absolute top-0 left-0 w-16 h-16 border-4 border-transparent border-t-red-400 border-r-red-300 rounded-full animate-spin"></div>
            {/* Center dot */}
        ...
        <div className="flex justify-center space-x-2 animate-in fade-in-50 duration-1000 delay-1100">
          ...
          <div className="w-3 h-3 bg-red-300 rounded-full animate-bounce delay-100"></div>
